...
class GenAI(BaseAI):
    ...
    def getMove(self, state, w_prey, w_hunter):
        ...
        predicted_move = nn.forward_propagation(np.array(
            [front_block_status, left_block_status, right_block_status, self_dir / 3, food_angle, food_distance,
             other_snake_angle, other_snake_distance]), weight)
